...
import { Building2, FileText, Clock, Trash2, Play } from "lucide-react"
...
export default function HomePage() {
  ...
  const handleResumeDraft = (draft: Draft) => {
    ...
    // Navigate to the correct step based on currentStep (only 3 steps now)
  ...
  const getStepName = (step: number) => {
    const steps = ["Keywords", "Meta", "Content"]
          ...
          <Card className="w-full">
            ...
            <CardContent className="space-y-4">
              ...
              <Button
                ...
                size="lg"
              >
                {startingBlog ? "Starting..." : "Start New Blog"}
              </Button>
            </CardContent>
          </Card>
