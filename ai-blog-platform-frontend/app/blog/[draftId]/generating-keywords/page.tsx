...
export default function GeneratingKeywordsPage() {
  ...
  const tasks = [
    "Analyzing company data and services",
    "Fetching industry trends and keywords", 
    "Generating AI-powered keyword suggestions",
    "Filtering and optimizing keyword options"
  ]
      ...
      <main className="max-w-5xl mx-auto px-6 py-8">
        <div className="space-y-8">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-gray-600">AI is analyzing your company and generating targeted keywords...</p>
          </div>
